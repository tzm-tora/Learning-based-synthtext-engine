...
def make_img_set_dir(save_path):
    makedirs(save_path)
    out_dir = os.path.join(save_path, 'out')
    Ipt_dir = os.path.join(save_path, 'Ipt')
    Ibg_dir = os.path.join(save_path, 'Ibg')
    makedirs(out_dir)
    makedirs(Ipt_dir)
    makedirs(Ibg_dir)
    # return out_dir, Ipt_dir, Ibg_dir
